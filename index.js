...
if(process.env.NODE_ENV === 'development') {
    ...
    fs.writeFileSync('/tmp/kickchatdev-service-account.json', JSON.stringify(serviceData), 'utf8');
    const serviceAccountData = require('/tmp/kickchatdev-service-account.json');
